    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header" style="background-color: var(--theme1-bg-color)!important;">
          <h5 class="modal-title" id="exampleModalLabel" style="color: var(--theme1-t-color)!important;">Registrars usuario admin</h5>
        ...
        <div class="modal-body">
            <form id="uform_register" style="display: grid;grid-gap: 5px;" method="post" action="" onsubmit="return false;">
                ...
                <button type="submit" class="miboton1_success">Registrar usuario</button>
                <button type="submit" class="miboton1_success" id="button_modificar">Modificar usuario</button>
              </form>
        </div>
